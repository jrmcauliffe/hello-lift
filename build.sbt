...
libraryDependencies += "org.eclipse.jetty" % "jetty-server" % "7.4.0.v20110414" % "compile->default"

libraryDependencies += "org.eclipse.jetty" % "jetty-servlet" % "7.4.0.v20110414" % "compile->default"
